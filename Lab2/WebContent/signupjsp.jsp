...
<body>
	...
	<div class="description">
	    <img class="mb-4" src="https://drive.google.com/uc?export=view&id=1TCH90GubkvWaebYRWbxRSVeTBvcCGqQh" alt="unio" width="72"
      height="72">
...
<div class="center_form">
	<form class="mx-sm-5" data-parsley-trigger="keyup"
		data-parsley-validate action="FormController">
		...
		<div class="form-row mb-4">
			<div class="col-sm-2">
				<label class="control-label" for="birthday">Fecha de
					nacimiento</label> <input class="form-control" id="birthday"
			...
			<div class="col-sm-2">
				<label for="gender">Género:</label> <select id="gender"
					name="gender" class="form-control" value="${model.gender}" required>
					<option></option>
		...
		<div class="form-row mb-4">
			<div class="col-sm-4">
				<label for="email" class="sr-only">Email</label> <input type="email"
					...
					required data-parsley-type="email" value="${model.email}" />
			</div>
		</div>
		<div class="form-row mb-4">
			<div class="col-sm-4">
				<label class="sr-only" for="pwd1">Contraseña:</label> <input
					...
					value="${model.pwd1}" /> <small id="passwordHelpBlock"
					class="form-text text-muted"> Your password must be 8-20
					characters long, contain lowercase and captial letters and numbers,
