			...
			<div class="form-row justify-content-center h-100 mb-2">
				<div class="form-group col-sm-2">
					<label class="sr-only" for="name">First Name</label> <input type="text"
						...
						value="${user.name}" pattern="[A-Za-z]+" required />
				</div>
				<div class="form-group col-sm-2">
			...
			<div class="form-row justify-content-center h-100 mb-4">
				<div class="col-sm-4">
					<label class="sr-only" for="pwd2">Confirm Password</label><input
						...
						placeholder="Confirm Password" aria-describedby="passwordHelpBlock"
						value="${user.pwd2}" required data-parsley-equalto="#pwd1" />
				</div>
			</div>
			<div class="form-row justify-content-center h-100 mb-4">
				<div class="col-auto">
					<div class="form-check">
						<input class="form-check-input" type="checkbox" id="termCheck"
							...
							for="termCheck"> I have read an agree to the <a
							href="PrivacyPolicy.html" target="popup"
							onclick="window.open('PrivacyPolicy.html','popup','width=600,height=600'); return false;">Terms of Use</a>
						</label>
					</div>
				</div>
			</div>
