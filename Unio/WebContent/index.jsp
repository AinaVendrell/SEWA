...
<script>
	...
	$(document).ready(
			function() {
				$('#duser').load('GetUserInfo', {
					uid : uid
				}, function() {
				})
				$('#dtweets').load('GetTweetsFromFollows', {
					uid : uid,
					start : start,
					end : start + nt
				}, function() {
				...
				$('.vT').click(function(event) {
					event.preventDefault()
					$('#dtweets').load('GetTweetsFromUser', {
						uid : uid,
						start : 0,
						end : nt
					}, function(data) {
					...
					<div class="w3-col m12">
						<div class="w3-card w3-round w3-white">
							<div class="w3-container w3-padding">
								...
								<p id="cT" contenteditable="true" class="w3-border w3-padding">
									Status: Feeling EPAW</p>
